...
export const useSwap = () => {
  ...
  const getPrice = async (
    ...
    const router = new AlphaRouter({ chainId: BASE_SEPOLIA_CHAIN_ID, provider: publicClient as any });
